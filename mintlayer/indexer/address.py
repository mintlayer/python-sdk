...
class AddressMixin(IndexerHTTP):
    ...
    def get_token_authority(self, address: str) -> list[str]:
        ...
        return self.get(f"/address/{_seg(address)}/token-authority") or []
