...
class TransactionMixin(IndexerCore):
    ...
    def get_transaction_merkle_path(self, tx_id: str) -> MerklePath:
        ...
        return MerklePath.from_json(self._get(f"/transaction/{_seg(tx_id)}/merkle-path"))
